...
We are going to briefly explain this approach using the code from the example [Working With Sample Parameters]({{% relref "documentation/python-examples/fitting/SampleParametersIntro.md" %}}).
...
See the complete code in the [Working with sample parameters]({{% relref "documentation/python-examples/fitting/SampleParametersIntro.md" %}}) example.
