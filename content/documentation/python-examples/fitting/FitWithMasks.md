...
* In the given example (see the [Python script]({{% relref "documentation/python-examples/fitting/FitWithMasks.md#python-script" %}})) we simulate cylinders on top of substrate without interference. The fitting procedure looks for the cylinder's height and radius.
